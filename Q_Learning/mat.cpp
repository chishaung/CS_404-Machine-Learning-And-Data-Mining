...
Matrix &Matrix::subRowVector(const Matrix &other)
{
    ...
    other.assertSize(1, maxc, "subRowVector");
...
// output: A row matrix of eigen values and a matrix of eigenvectors (one vector in each row)
